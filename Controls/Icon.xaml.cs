...
[assembly: XmlnsPrefix("http://schemas.aw.fontawesome.wpf", "fa")]
[assembly: XmlnsDefinition("http://schemas.aw.fontawesome.wpf", "AW.FontAwesome.WPF.Controls")]
...
namespace AW.FontAwesome.WPF.Controls
{
    ...
    {
        private static FontFamily _Brands = new FontFamily(new Uri("pack://application:,,,/AW.FontAwesome.WPF;component/"), "./Font-Awesome/otfs/#Font Awesome 6 Brands Regular");
        private static FontFamily _Solid = new FontFamily(new Uri("pack://application:,,,/AW.FontAwesome.WPF;component/"), "./Font-Awesome/otfs/#Font Awesome 6 Free Solid");
        private static FontFamily _Regular = new FontFamily(new Uri("pack://application:,,,/AW.FontAwesome.WPF;component/"), "./Font-Awesome/otfs/#Font Awesome 6 Free Regular");

        public FaStyles FaStyle
        {
            get => (FaStyles)GetValue(FaStyleProperty);
        ...
        {
            get => (string)GetValue(FaNameProperty);
